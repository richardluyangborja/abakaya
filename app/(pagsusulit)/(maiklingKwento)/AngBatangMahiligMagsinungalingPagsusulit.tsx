...
const QUESTIONS = [
  {
    id: 1,
    question: "Mahilig magsinungaling si Elisa.",
    choices: ["Tama", "Mali"],
    answerIndex: 0,
  },
  {
    id: 2,
    question:
      "Laging nagsasabi ng totoo si Elisa sa kanyang pamilya at paaralan.",
    choices: ["Tama", "Mali"],
    answerIndex: 1,
  },
  {
    id: 3,
    question:
      "Binigyan ng engkantada si Elisa ng parusa dahil sa pagsisinungaling.",
    choices: ["Tama", "Mali"],
    answerIndex: 0,
  },
  {
    id: 4,
    question: "Nawala ang boses ni Elisa dahil sa kanyang kasinungalingan.",
    choices: ["Tama", "Mali"],
    answerIndex: 0,
  },
  {
    id: 5,
    question: "Nangakong hinding-hindi na muling magsisinungaling si Elisa.",
    choices: ["Tama", "Mali"],
    answerIndex: 0,
  },
];
