...
const QUESTIONS = [
  {
    id: 1,
    question: "Kilala si Popong sa kayamanan.",
    choices: ["Tama", "Mali"],
    answerIndex: 1,
  },
  {
    id: 2,
    question: "Laging bumabati at nagmamano si Popong sa kanyang pamilya.",
    choices: ["Tama", "Mali"],
    answerIndex: 0,
  },
  {
    id: 3,
    question: "Hindi tumutulong si Popong sa bahay.",
    choices: ["Tama", "Mali"],
    answerIndex: 1,
  },
  {
    id: 4,
    question: "Tinulungan ni Popong ang matandang kapitbahay.",
    choices: ["Tama", "Mali"],
    answerIndex: 0,
  },
  {
    id: 5,
    question: "Hindi marunong si Popong magbahagi sa laro.",
    choices: ["Tama", "Mali"],
    answerIndex: 1,
  },
];
...
export default function AngBatangMabaitAtMagalangPagsusulit() {
