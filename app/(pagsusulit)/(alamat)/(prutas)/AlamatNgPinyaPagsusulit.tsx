...
const QUESTIONS = [
  {
    ...
    choices: ["A. Simo", "B. Gabriel", "C. Pinang"],
    answerIndex: 2,
  },
  {
    id: 2,
    ...
    choices: [
      "A. Mahal siya ng ina at sunod sa layaw",
      "B. Mahilig sa laro",
      "C. Mahina ang katawan",
    ],
    answerIndex: 0,
  },
  {
    ...
    choices: [
      "A. Nasunog at dumikit sa palayok",
      "B. Maayos niyang niluto",
      "C. Hindi niluto",
    ],
    answerIndex: 0,
  },
  ...
  },
  {
    ...
    choices: ["A. Pinya", "B. Kalabasa", "C. Mangga"],
    answerIndex: 0,
  },
];
