...
const QUESTIONS = [
  ...
  },
  {
    ...
    choices: [
      "A. Walang makain at palipat-lipat ng tirahan",
      "B. May maraming hayop sa kanilang tahanan",
      "C. Napakaabala sa pagtuturo ng iba",
    ],
    answerIndex: 0,
  },
  {
    ...
    choices: [
      "A. Ang kanyang asawa, Banag",
      "B. Ang mga damo sa parang",
      "C. Ang mga kapitbahay",
    ],
    answerIndex: 1,
  },
  {
    ...
    choices: [
      "A. Nagtayo siya ng malaking bahay",
      "B. Gumawa siya ng malawak na bukid at itinuro sa iba",
      "C. Nagtago sa bundok",
    ],
    answerIndex: 1,
  },
  {
    ...
    choices: ["A. Palay", "B. Munga", "C. Mais"],
    answerIndex: 0,
  },
];
  ...
  return (
    ...
    >
      <View style={{ flex: 1 }}>
        ...
        <Image
          source={require("../../../../assets/images/PALAY.png")}
          style={{
            height: 160,
            width: 280,
            position: "absolute",
