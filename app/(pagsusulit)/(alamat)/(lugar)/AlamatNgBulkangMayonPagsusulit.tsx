...
const QUESTIONS = [
  {
    ...
    choices: ["Pinang", "Elisa", "Magayon"],
    answerIndex: 2,
  },
  {
    id: 2,
    question: "Sino ang binatang umibig kay Magayon?",
    choices: ["Pagtuga", "Alapaap", "Gabriel"],
    answerIndex: 1,
  },
  {
    id: 3,
    ...
    choices: [
      "Para iligtas ang kanyang ama",
      "Para makapaglaro",
      "Para makakuha ng kayamanan",
    ],
    answerIndex: 0,
  },
  {
    ...
    choices: [
      "Namatay sila at inilibing nang magkasama",
      "Nakatakas sila sa bundok",
      "Nagpakasal sila at namuhay nang masaya",
    ],
    answerIndex: 0,
  },
  {
    ...
    choices: [
      "Ang kagubatan sa Bicol",
      "Ang bundok ay si Magayon at usok ni Pagtuga",
      "Ang ilog sa nayon",
    ],
    answerIndex: 1,
  },
