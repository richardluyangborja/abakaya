...
const QUESTIONS = [
  {
    id: 1,
    question: "Saan nakatira ang mag-aamang higante?",
    choices: ["A. Sa bundok", "B. Sa kweba", "C. Sa gubat"],
    answerIndex: 2,
  },
  {
    id: 2,
    question: "Ilan ang anak ng higante?",
    choices: ["A. Dalawa", "B. Tatlo", "C. Apat"],
    answerIndex: 1,
  },
  {
    id: 3,
    question: "Sino ang unang lumabas ng kweba?",
    choices: ["A. Lu", "B. Bisaya", "C. Minda"],
    answerIndex: 0,
  },
  {
    id: 4,
    question: "Ano ang tumangay sa magkakapatid?",
    choices: ["A. Malakas na hangin", "B. Dambuhalang alon", "C. Malaking isda"],
    answerIndex: 0,
  },
  {
    id: 5,
    question: "Ano ang naging pangalan ng tatlong pulo?",
    choices: [
      "A. Luzon, Visayas, Mindanao",
      "B. Palawan, Cebu, Davao",
      "C. Maynila, Bohol, Samar",
    ],
    answerIndex: 0,
  },
];
